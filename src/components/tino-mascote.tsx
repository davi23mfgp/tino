...
export function TinoMarca({
  ...
  /**
   * O leão a traço é máscara, não imagem colorida.
   *
   * O desenho é tinta preta: sobre o fundo escuro do app ele sumiria. Como
   * máscara, a cor vem do `currentColor` de quem o usa, então a mesma arte
   * serve à barra lateral, ao tema claro e a qualquer superfície futura.
   */
  return (
    <span
      role="img"
