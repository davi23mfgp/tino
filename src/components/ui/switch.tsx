...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitive.Thumb
      className={cn(
        "pointer-events-none block size-7 rounded-full bg-primary-foreground shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-6 data-[state=unchecked]:translate-x-0"
      )}
    />
  </SwitchPrimitive.Root>
))
