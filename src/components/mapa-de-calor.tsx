  ...
  return (
    <div>
      <div className="flex gap-1.5">
        ...
        <div className="flex flex-col gap-1 pr-1">
          {INICIAIS.map((inicial, indice) => (
            <span key={indice} className="flex h-7 items-center text-[max(10px,calc(12px*var(--escala-letra)))] text-muted-fg">
              {inicial}
            </span>
          ))}
        </div>
              ...
              {Array.from({ length: 7 }, (_, posicao) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "flex h-7 items-center justify-center rounded-md text-[max(10px,calc(12px*var(--escala-letra)))] tabular-nums transition-colors",
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-1.5 text-[max(10px,calc(12px*var(--escala-letra)))] text-muted-fg">
          menos
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1 text-[max(10px,calc(12px*var(--escala-letra)))] text-muted-fg">
          <span>
