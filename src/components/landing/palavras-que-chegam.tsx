...
export function PalavrasQueChegam({children,className=""}:{children:ReactNode;className?:string}) {
  ...
  useEffect(()=>{
    ...
    // O Strict Mode monta, desmonta e monta o efeito de novo em desenvolvimento.
    // Na segunda passagem as palavras já existem, mas o observador anterior já
    // foi desligado. Reaproveitar o DOM e religar a revelação evita um título
    // permanentemente invisível sem aninhar spans.
