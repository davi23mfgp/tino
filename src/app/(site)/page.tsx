  ...
  return <>
    ...
    <main id="conteudo">
      ...
      <section className="cerca landing-feature-grid" id="recursos" aria-label="O Tino no seu bolso">
        {TELAS.map(item => <Revelar key={item.n} className="landing-feature"><div className="landing-feature-copy"><span className="eyebrow">{item.n} / No seu bolso</span><PalavrasQueChegam><h3 className="display">{item.titulo}</h3></PalavrasQueChegam><p>{item.texto}</p></div><div className="landing-feature-phone"><TelaNoCelular tela={item.tela} /></div></Revelar>)}
      </section>
      ...
      <section className="cerca landing-future">
        <Revelar><p className="eyebrow">Hoje é um bom começo</p><PalavrasQueChegam><h2 className="display">Antes do aperto.<br /><span className="em-alta">Depois, com calma.</span></h2></PalavrasQueChegam><p>Veja como seu saldo pode mudar nos próximos meses. Experimente cenários e decida com mais contexto.</p><Link href="/cadastro" className="landing-text-link">Quero enxergar meu próximo mês <ArrowRight size={18} aria-hidden /></Link></Revelar>
        <Revelar className="landing-chart"><FitaDoTempo /></Revelar>
      </section>
      <section className="cerca landing-steps" id="como-funciona">
        <Revelar><p className="eyebrow">Como funciona</p><PalavrasQueChegam><h2 className="display">Começar é simples.<br />Continuar também.</h2></PalavrasQueChegam></Revelar>
      ...
      <section className="cerca landing-resources">
        <Revelar><p className="eyebrow">Cresce com você</p><PalavrasQueChegam><h2 className="display">Simples no começo.<br />Completo quando quiser.</h2></PalavrasQueChegam></Revelar>
      ...
      <section className="cerca landing-pricing" id="planos">
        <Revelar className="landing-centered"><p className="eyebrow">Cabe nos seus planos</p><PalavrasQueChegam><h2 className="display">Clareza para o dinheiro.<br />Inclusive no preço.</h2></PalavrasQueChegam><p>{dias} dias para conhecer o Tino. Sem cartão para começar.</p></Revelar>
        <div className="planos">{planos.map((plano,i)=><article key={plano.codigo} className={`plano soft-card ${i===planos.length-1 ? "plano--destaque" : ""}`}>
          ...
          <p className="numero plano-preco"><NumeroQueSobe centavos={plano.mensalCentavos} /><span className="plano-por">/mês</span></p>
      ...
      <section className="cerca landing-faq" id="duvidas">
        <div><p className="eyebrow">Sem ponto solto</p><PalavrasQueChegam><h2 className="display">Dúvidas?<br />Vamos lá.</h2></PalavrasQueChegam></div>
      ...
      <section className="cerca landing-final"><Revelar><p className="eyebrow">Dê um pouco de tino ao seu dinheiro</p><PalavrasQueChegam><h2 className="display">A sua virada<br />começa aqui.</h2></PalavrasQueChegam><Link href="/cadastro" className="botao">Testar {dias} dias de graça <ArrowRight size={18} aria-hidden /></Link><p className="landing-note">Um passo de cada vez. Do seu jeito.</p></Revelar><Leao tamanho={270} flutua /></section>
    </main>
