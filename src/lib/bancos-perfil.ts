...
export function corDoBanco(instituicao: string | null | undefined): string {
  ...
  // Cores institucionais publicadas pelas próprias marcas. Marca clara (o
  // amarelo do Banco do Brasil) é legítima aqui: quem garante o texto branco
  // por cima é o véu escuro do cartão, não uma cor de marca falseada.
